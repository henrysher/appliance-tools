...
path to a file to include in the appliance package
...
Packge format, will package up output, disk images and meta into a standad package.  Currnetly only zip is supported. (default is "none")
